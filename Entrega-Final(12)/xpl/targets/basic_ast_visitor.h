...
public:
  ...
  inline bool isDouble(basic_type* t) {
      return t->name()==basic_type::TYPE_DOUBLE;
  }
  inline bool isInt(basic_type* t) {
      return t->name()==basic_type::TYPE_INT;
  }
  inline bool isPointer(basic_type* t) {
      return t->name()==basic_type::TYPE_POINTER;
  }
  inline bool isVoid(basic_type* t) {
      return t->name()==basic_type::TYPE_VOID;
  }
  inline bool isString(basic_type* t) {
      return t->name()==basic_type::TYPE_STRING;
  }
